...
IF OBJECT_ID(N'[dbo].[FK_VehiculoClase]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Vehiculos] DROP CONSTRAINT [FK_VehiculoClase];
GO
IF OBJECT_ID(N'[dbo].[FK_VehiculoCaja]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Vehiculos] DROP CONSTRAINT [FK_VehiculoCaja];
GO
IF OBJECT_ID(N'[dbo].[FK_DescuentoCaja]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Descuentos] DROP CONSTRAINT [FK_DescuentoCaja];
GO
IF OBJECT_ID(N'[dbo].[FK_CajaPagoMensual]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[PagoMensuales] DROP CONSTRAINT [FK_CajaPagoMensual];
GO
IF OBJECT_ID(N'[dbo].[FK_MensualPagoMensual]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[PagoMensuales] DROP CONSTRAINT [FK_MensualPagoMensual];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Impresiones]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Impresiones];
GO
IF OBJECT_ID(N'[dbo].[Descuentos]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Descuentos];
GO
IF OBJECT_ID(N'[dbo].[Mensuales]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Mensuales];
GO
IF OBJECT_ID(N'[dbo].[PagoMensuales]', 'U') IS NOT NULL
    DROP TABLE [dbo].[PagoMensuales];
GO
IF OBJECT_ID(N'[dbo].[Recordatorios]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Recordatorios];
GO
