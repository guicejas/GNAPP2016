<%@ Page Title="" Language="C#" MasterPageFile="~/Garage/Garage.Master" AutoEventWireup="true" CodeBehind="reportefacturacion.aspx.cs" Inherits="APPWEB.Garage.reportefacturacion" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContentGarage" runat="server">
    ...
    <div>
        <ol class="breadcrumb">
            ...
            <li class="active">Reporte de Facturación</li>
        </ol>
    </div>
    <h3>
        Reporte de Facturación</h3>
    <br />
