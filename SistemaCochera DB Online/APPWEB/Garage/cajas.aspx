        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <script type="text/javascript">Sys.Application.add_load(Calendario); </script>
               ...
               <div class="col-lg-4 col-sm-6 col-xs-12" style="padding-left: 1px">
                ...
                <asp:GridView ID="GridCajas" BorderWidth="1px"  BorderColor="#dddddd" runat="server" Width="100%" CellPadding="50" CellSpacing="50"
                    GridLines="Horizontal" ForeColor="#333333" AllowSorting="true" AutoGenerateColumns="false"
                    AllowPaging="True" PageSize="100" OnPageIndexChanging="GridCajas_PageIndexChanging">
                    <EmptyDataTemplate>
                        No hay cajas.
                    </EmptyDataTemplate>
                    <Columns>
                        ...
                        <asp:BoundField DataField="TotalNeto" HeaderText="Recaudado" DataFormatString="{0:C}" />
                        <asp:BoundField ItemStyle-HorizontalAlign="Center" DataField="CantidadVehiculos" HeaderText="Cant Veh" />
                    </Columns>
