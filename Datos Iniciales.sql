...
USE [SistemaCocheraBD]
GO
/****** Object:  Table [dbo].[Sistemas]    Script Date: 02/02/2016 13:06:10 ******/
SET IDENTITY_INSERT [dbo].[Sistemas] ON
INSERT [dbo].[Sistemas] ([id], [password], [NombreImpresora], [NumeracionTickets], [NumeracionCajas], [CheckSiempreTOP], [CheckSiempreMaximizado], [CheckCodigoCerrar], [CodigoCierre]) VALUES (1, N'0', N'EPSON TM-T88V Receipt', 1649, 156, 1, 1, 1, N'1')
...
INSERT Mensuales VALUES ('SINDICATO DEL VESTIDO', 'PEUGEOT 308', 'OHG 653', 'OROÑO 465', '4256726 4254599 156416016 153785411  insert into Mensuales values (Alejandro)', '', '', '', 'B', 11, 1, CAST(2300.00 AS Decimal(10, 2)), 'DIURNO', CAST(0x0000A17700000000 AS DateTime), CAST(0x0000000000000000 AS DateTime), 'PEUGEOT 307  -GXW 727-')
INSERT Mensuales VALUES ('BELMONTE MARIANO', 'PEUGEOT 207', 'KGC 806', 'OROÑO 480 2DO A', '111562147271', 'CAR SECURITY', 'SAN LORENZO 3887 OLIVOS ', '30-69874417-7', 'B', 12, 1, CAST(1100.00 AS Decimal(10, 2)), 'NOCTURNO', CAST(0x0000A1B400000000 AS DateTime), CAST(0x0000000000000000 AS DateTime), 'CHEVROLET AGILE -NKK 221- | VOLKSWAGEN SAVEIRO  -??? 901-')
...
INSERT Mensuales VALUES ('RIGATUSO ADRIA', 'BMW ', 'NEE 811', 'OROÑO 405', '156465636 4474646 156465634  insert into Mensuales values (marisa)', 'RIGATUSO ADRIA', 'OROÑO 405', '20-20812558-4', 'A', 14, 1, CAST(2600.00 AS Decimal(10, 2)), 'DIURNO', CAST(0x0000A29700000000 AS DateTime), CAST(0x0000000000000000 AS DateTime), 'RANGE ROVER -NLE 935-  |  HONDA CRV -GRW 981- | VOLVO S40 -GNX 711-')
...
INSERT Mensuales VALUES ('SALINAS SILVINA', 'PEUGEOT 208', 'NCA 644', 'OROÑO 480 5TO C', '153579005 156829983  insert into Mensuales values (trabajo)', 'FRESENIUS KABI SA', 'AVENIDA CABILDO 2677 CABA', '30-6929719-3', 'A', 17, 0, CAST(1500.00 AS Decimal(10, 2)), '24HS', CAST(0x0000A33E00000000 AS DateTime), CAST(0x0000A59E00000000 AS DateTime), '')
